<template>
  <div class="myData_cont">
    ...
    <!--我的资料-->
      <el-col :span="16">
        <el-card>
          <el-col :span="6">
            <div class="img">
              <img src="https://account.xiaomi.com/static/img/passport/photo.jpg" alt="头像" @click="dialogFormVisible2 = true">
    ...
    <el-dialog title="点击上传头像"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="updateMoNo('moNoForm')">确定</el-button>
      </div>
