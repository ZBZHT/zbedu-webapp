...
//定义comments
let testQuestionSchema = new mongoose.Schema({
  status: Number,
  msg: String,
  testId: Number,
  state:Number,   //0:表示未开始不显示  1:表示已开始显示
  currTestNum:Number,
  title: String,
  desc: String,
  question: [questionSchema]
});
let TestQuestion = mongoose.model("TestQuestion", testQuestionSchema);
