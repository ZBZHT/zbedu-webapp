    ...
    <div class="classPlan">
      <div class="classPlan_top">
        ...
        <div class="classPlan_topRight">
            ...
            <ul>
              <!--<li class="classDataP eachDataP" v-show = "course">1</li>-->
              <li class="eachDataP" v-for="(item3,index3) in course.newCourse" :style="{color:item3.color}">
            ...
            <ul>
              <!--<li class="classDataP eachDataP" v-show = "course">2</li>-->
              <li class="eachDataP" v-for="(item3,index3) in course.newCourse2" :style="{color:item3.color}">
                <div class="topdiv" v-show="item3.teacher !== ''">
                  <div>{{item3.startTime}}~{{item3.endTime}}</div>
                  <div>{{item3.teacher}}</div>
                  <div>{{item3.courseName}}</div>
            ...
            <ul>
              <!--<li class="classDataP eachDataP" v-show = "course">3</li>-->
              <li class="eachDataP" v-for="(item3,index3) in course.newCourse3" :style="{color:item3.color}">
                <div class="topdiv" v-show="item3.teacher !== ''">
                  <div>{{item3.startTime}}~{{item3.endTime}}</div>
                  <div>{{item3.teacher}}</div>
                  <div>{{item3.courseName}}</div>
            ...
            <ul>
              <!--<li class="classDataP eachDataP" v-show = "course">4</li>-->
              <li class="eachDataP" v-for="(item3,index3) in course.newCourse4" :style="{color:item3.color}">
                <div class="topdiv" v-show="item3.teacher !== ''">
                  <div>{{item3.startTime}}~{{item3.endTime}}</div>
                  <div>{{item3.teacher}}</div>
                  <div>{{item3.courseName}}</div>
            ...
            <ul>
              <!--<li class="classDataP eachDataP" v-show = "course">5</li>-->
              <li class="eachDataP" v-for="(item3,index3) in course.newCourse5" :style="{color:item3.color}">
                <div class="topdiv" v-show="item3.teacher !== ''">
                  <div>{{item3.startTime}}~{{item3.endTime}}</div>
                  <div>{{item3.teacher}}</div>
                  <div>{{item3.courseName}}</div>
...
<style>
  * {
  ...
  .showTable .eachDataP div {
    margin-bottom: 6px;
    text-align: left;
    margin-left: 6px;
    margin-top: 13px;
  }
  .showTable .eachDataP .topdiv {
    position: absolute;
    top:-17px;
    left: 0;
  }
