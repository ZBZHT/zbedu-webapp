  ...
  <div class="loginPage">
    <el-dialog title="请登录" :visible.sync="$store.state.loginPage" width="30%">
      <form class="v-modal-prompt-form">
        ...
        <input name="fname" type="text" ref="input" v-model="username" class="v-modal-input"
               placeholder="昵称/ID/身份证号/手机号" autocomplete="on" autofocus="autofocus">
        <p><img class="psw" src="../../assets/imgs/psw.png"></p>
        <input name="fpassword" type="password" ref="input" v-model="password" class="v-modal-input" placeholder="密码"
               @keyup.enter="login" autocomplete="new-password">
